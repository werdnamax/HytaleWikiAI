...
def genLayer2():
    ...
    with open('data/endpoints/scraper_output.json', 'w') as f:
    ...
    with open('data/endpoints/scraper_output_layer2.json', 'w') as f:
...
def genLayer3():
    ...
    with open('data/endpoints/scraper_output_layer2.json', 'r') as f:
        layer2 = json.load(f)
